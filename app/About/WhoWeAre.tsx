    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            We are here to help small businesses succeed online
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Koda.io is a digital solutions agency that empowers entrepreneurs
            and business owners to grow their online presence and reach their
            full potential. We provide innovative tools and expert guidance to
            bridge the digital divide between small businesses and the online
            world.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui ipsa
            commodi pariatur libero unde odit quod dolores accusamus placeat
            nostrum rem perferendis dicta laborum, voluptatibus explicabo
            tenetur! Corrupti ducimus quaerat magnam similique unde mollitia
            ipsum adipisci deserunt id officia voluptatem facilis, voluptates
            nesciunt, fugiat numquam! Ullam quidem modi dicta velit.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <img
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            We offer cutting-edge digital toolkits that help small businesses
            build next-generation websites faster and more efficiently.
          </p>
        </div>
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Our team of experts provides guidance and support to help small
            business owners navigate the digital landscape and protect their
            online presence.
          </p>
        </div>
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
            Our mission is to bridge the digital divide between small businesses
            and the online world. We believe that every business deserves a
            strong online presence, regardless of size or budget. We`re
            committed to providing accessible, effective, and affordable digital
          ...
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
            We empower small business owners with the knowledge and tools they
            need to succeed online. Our commitment to innovation ensures that
            our clients receive the latest and most effective solutions, while
            our expertise guarantees the best guidance and support.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  We believe in empowering small business owners with the
                  knowledge and tools they need to succeed online.
                </p>
              </div>
            </div>
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  ...
                  innovation, ensuring our clients receive the latest and most
                  effective solutions.
                </p>
              </div>
            </div>
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  We pride ourselves on our team`s expertise and experience in
                  digital solutions, ensuring our clients receive the best
